...
export const ROUTE_PERMISSIONS = {
  ...
  "/accounts-users": [PERMISSIONS.USERS_READ],
  "/reports": [PERMISSIONS.DASHBOARD_READ, PERMISSIONS.USERS_READ, PERMISSIONS.TRIPS_READ],
  "/reports/accounts": [PERMISSIONS.DASHBOARD_READ, PERMISSIONS.USERS_READ, PERMISSIONS.TRIPS_READ],
  "/reports/employees": [PERMISSIONS.DASHBOARD_READ, PERMISSIONS.USERS_READ, PERMISSIONS.TRIPS_READ],
