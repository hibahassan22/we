...
const ROUTE_LABELS = {
  ...
  "/accounts-users": { label: "الأكاونتات",        icon: "👤" },
  "/reports":       { label: "التقارير",          icon: "📈" },
  "/reports/accounts": { label: "تقارير الأكاونتات", icon: "📈" },
  "/reports/employees": { label: "تقارير الموظفين", icon: "📈" },
  "/system":        { label: "إدارة النظام",       icon: "⚙" },
  "/accounts":      { label: "الحسابات",           icon: "💳" },
  "/accounts/drivers": { label: "حسابات السائقين", icon: "💳" },
